...
Supported command groups: strings, keys, connection. See [KV from PHP](/docs/guides/kv-from-php/) for the full command list.
...
- [KV from PHP](/docs/guides/kv-from-php/) — the SAPI and RESP APIs
- [`ephpm kv` CLI](/docs/reference/cli/kv/) — debug the live store
- [Architecture → Clustering](/docs/architecture/clustering/) — gossip, hash ring, data plane
