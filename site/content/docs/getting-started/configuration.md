...
- [Reference → Configuration](/docs/reference/config/) — exhaustive list of every key, type, and default.
- [Reference → Environment Variables](/docs/reference/environment-variables/) — the `EPHPM_` mapping rules.
- [Guides](/docs/guides/) — task-oriented configs (WordPress, Laravel, vhosts, TLS, clustering).
