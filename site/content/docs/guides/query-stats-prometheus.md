...
- [Architecture → Query Stats](/docs/architecture/query-stats/) — how the normalizer works
- [Reference → Metrics](/docs/reference/metrics/) — every metric ePHPm exposes
- [Reference → Configuration `[db.analysis]`](/docs/reference/config/)
