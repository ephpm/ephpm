...
- (See [Reference → Metrics](/docs/reference/metrics/) for the full list.)
...
- [Architecture → Clustering](/docs/architecture/clustering/) — design rationale and protocol details
- [Architecture → Database](/docs/architecture/database/) — sqld lifecycle and election internals
