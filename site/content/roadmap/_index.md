...
- **[SSE & Realtime](sse-realtime/)** — `ephpm_kv_wait()` and streaming brotli **shipped**; the render-once/fan-out SSE hub that decouples viewer count from `worker_count` is the v0.7 target.
