...
mod tests {
    ...
    fn single_node_path_does_not_use_kv_cache() {
        ...
        let cfg = TlsConfig {
            ...
            linode_api_token_file: None,
            linode_api_token: None,
            digitalocean_api_token_file: None,
            digitalocean_api_token: None,
            route53_access_key_id: None,
            route53_secret_access_key_file: None,
            route53_secret_access_key: None,
            route53_hosted_zone_id: None,
            google_service_account_json_file: None,
            google_service_account_json: None,
            google_project: None,
            google_managed_zone: None,
            listen: None,
            redirect_http: false,
        };
        let setup =
